...
namespace uisits\Compoships;

use uisits\Compoships\Database\Eloquent\Concerns\HasRelationships;
use uisits\Compoships\Database\Query\Builder as QueryBuilder;
...
trait Compoships
{
     ...
     *
     * @return \uisits\Compoships\Database\Query\Builder|static
     */
